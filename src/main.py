...
def main():
    # Import mesh
    mesh = o3d.io.read_triangle_mesh("src/meshes/hailpad_normalized.stl")
    ...
    # Rotate by bounding box rotation matrix (T for transpose)
    pcd.rotate(bb.R.T)
    ...
    # Normal depth values between 0-1.0 (required for using as an image)
    z -= z.min()
    dmap = z / z.max()
